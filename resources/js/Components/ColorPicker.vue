    ...
    <div class="p-3 pb-1 bg-transparent">
        <div class="flex flex-col justify-between">
            <div class="rounded-full relative">
                <input class="w-full h-12 rounded" type="color" v-model="form.selectedColor" @input="updateColorFromMain"/>
                <span class="pointer-events-none absolute inset-y-0 right-0 flex items-center pr-2.5 mb-0.5">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                         class="w-6 h-6 bg-amber-50/70 rounded">
